...
export function renderFixture({ secondaryFarBelow = false }: { secondaryFarBelow?: boolean } = {}) {
  ...
  const video: PublicMedia = { kind: 'video', snapshotId: 'test-only', src: '/work/test-only/clip.webm', poster: '/work/test-only/secondary.png', width: 32, height: 20, alt: 'A blue test clip', caption: 'Synthetic browser video.', transcript: 'A blue frame stays visible.', captions: [{ start: 0, end: 1, text: 'A blue frame stays visible.' }] };
  ...
  return renderToStaticMarkup(
    <div className={styles.surface} data-showcase-surface>
      ...
      <div className={styles.content} data-fixture-content>
        ...
        {secondaryFarBelow && <div style={{ height: 12000 }} aria-hidden="true" />}
