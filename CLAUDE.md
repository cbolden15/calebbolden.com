...
- Lead magnets source + packaging playbook: docs/consulting/lead-magnets/
- Business docs (MSA draft, outreach templates, E&O research): docs/consulting/
...
- [ ] Follow-up email sequences: write the 5-email sequence copy per magnet (spec in docs/consulting/lead-magnets/README.md). No list provider yet; at current volume Caleb sends manually.
...
- [ ] Send first outreach: chamber + one adjacent professional, using docs/consulting/materials/outreach-templates.md and pointing at the free tools. Highest-leverage item on this list.
- [ ] Run E&O quotes (Hiscox + TechInsurance/Insureon + Embroker; questions in docs/consulting/research/eo-insurance-options.md).
- [ ] Send the MSA draft (docs/consulting/materials/msa-template.md) to an attorney before signing the first client.
