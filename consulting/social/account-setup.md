...
**9. First batch.** Film the `data and systems` dimension of `consulting/social/syllabus.md`, weeks 1 through 4, in one 30-minute session. That covers four questions, four clips, and four essays before moving to the next monthly batch.
