...
- **Substantiation:** the delivered build exists at `public/clients/brittany-lyons/` (index, about, contact, faq, investment, three area pages, more than ten journal posts, logo, hero video), password-gated by `proxy.ts`. `consulting/brand/asset-checklist.md:109` records it as "Delivered client work as a standing proof asset." `consulting/launch-roadmap.md:131` treats it as evidence at least one engagement exists. **Blocking gate:** Caleb confirms this was a real delivered engagement, and obtains written permission to name her and show the work. Without both, this recommendation is void, not softened. No number goes on the page unless the client will stand behind it.
