      ...
      <div className={showcaseStyles.content}>
        ...
        {developerTools.length ? (
          <div className="mt-12" data-home-group="developer-tools">
            <Reveal><p className="anno anno-blue mb-3">developer tools</p></Reveal>
            <div style={{ borderTop: '1px solid var(--color-hairline)' }}>
              {developerTools.map((project, index) => (
                <Reveal key={project.slug} delay={index * 60}>
                  <article className={`${showcaseStyles.row} py-5`} style={{ borderBottom: '1px solid var(--color-hairline)' }} data-home-project={project.slug}>
                    <div>
        ...
        {secondary.length ? (
          <div className="mt-12" data-home-group="secondary">
            <Reveal><p className="anno anno-blue mb-3">more products and tools</p></Reveal>
            <div style={{ borderTop: '1px solid var(--color-hairline)' }}>
